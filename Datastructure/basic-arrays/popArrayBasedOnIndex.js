...
// and returns a new array.elem represents an element that
// may or may not be present on one or more of the arrays
// nested within arr.Modify the function, using a for loop,
